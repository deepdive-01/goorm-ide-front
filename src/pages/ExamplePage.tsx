    ...
    <div className="bg-background grid min-h-screen grid-cols-2 items-start gap-12 p-10">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          />
          <p className="text-body3 text-gray-600">size</p>
          ...
          <p className="text-body3 text-gray-600">color</p>
          <div className="flex flex-wrap items-center gap-4">
            <Spinner size="md" color="text-neon-green" />
      ...
      <div className="flex flex-col gap-4">
        ...
        <PropsTable
          rows={[
            { prop: 'ariaLabel', type: 'string', default: '—', required: true },
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Badge size="md" shape="circle" bgOpacity={50} ariaLabel="opacity 50">
            50
          </Badge>
          <Badge size="md" shape="circle" bgOpacity={20} ariaLabel="opacity 20">
            20
          </Badge>
        </div>
      </div>
