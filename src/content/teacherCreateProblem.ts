export const TEACHER_CREATE_PROBLEM_COPY = {
  pageTitle: '새 문항 만들기',
  editPageTitle: '문항 수정',
  problemNotFound: '문항을 찾을 수 없습니다.',
  invalidSpace: '유효한 스페이스를 찾을 수 없습니다.',
  save: '저장',
  saving: '저장 중…',
  titleRequired: '문항 제목을 입력해주세요',
  languageRequired: '프로그래밍 언어를 선택해주세요',
  descriptionRequired: '문제 설명을 입력해주세요',
  testcasesRequired: '테스트 케이스를 추가해주세요',
  inputRequired: '입력값을 입력해주세요',
  expectedOutputRequired: '예상 출력값을 입력해주세요',
  saveError: '문항 저장에 실패했습니다. 입력 내용을 확인해 주세요.',
  networkError: '네트워크 연결 오류가 발생했습니다. 다시 시도해주세요.',
